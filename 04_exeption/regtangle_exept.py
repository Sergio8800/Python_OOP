...
class Validator:
    def __init__(self, min_value,string_par):
        self.min_value = min_value
        self.string_par = string_par
    ...
    def __set__(self, instance, value):
        try:
            ...
            print(f'__main__.{NegativeValueError.__name__}: {self.string_par} должна быть положительной, а не {value}')
        else:
...
class Rectangle:
    ...
    """
    width = Validator(0, "Ширина")  # дескриптор
    height = Validator(0, "Длинна")  # дескриптор
